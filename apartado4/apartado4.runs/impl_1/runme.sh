...
HD_PWD='C:/Users/oscar/OneDrive/Escritorio/UNIVERSIDAD/MSC_22_23/MSC/apartado4/apartado4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_dac_controlller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_dac_controlller.tcl -notrace
